...
function SubmitNow(category) {
	 ...
	 if (res == ""){
	 	...
	 	window.location.href = "http://localhost:8080/Perl_2/market.cgi?"
	 }
     ...
     if (category == "fruit") { window.location.href = "http://localhost:8080/Perl_2/fruit.cgi?" + suserfile }

     else { window.location.href = "http://localhost:8080/Perl_2/veggies.cgi?" + suserfile }
